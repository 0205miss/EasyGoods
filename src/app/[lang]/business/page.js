'use client'
import { Button, Dropdown, DropdownMenu, DropdownSection, DropdownTrigger,DropdownItem, Tab, Tabs, Spinner } from "@nextui-org/react";
...
export default function BusinessPage() {
  ...
  useEffect(()=>{
    if(currentshop==null || currentshop =='') return
